                    ...
                    <?php if ($isLoggedIn): ?>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo getDashboardUrl($userRole); ?>">
                        ...
                        <div class="card-body">
                            ...
                            <div class="plan-features">
                                <div class="feature-row">
                                    <span class="feature-text">3 meals per day</span>
                                    <i class="fas fa-check feature-check"></i>
                                </div>
                                <div class="feature-row">
                                    <span class="feature-text">Rotating weekly menu (simple veg/non-veg meals)</span>
                                    <i class="fas fa-check feature-check"></i>
                                </div>
                                <div class="feature-row">
                        ...
                        <div class="accordion" id="faqAccordion" style="animation: slideInRight 0.6s ease-out 0.2s both;">
                            <div class="accordion-item">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#faqAccordion" style="transition: all 0.4s ease;">
                                    <div class="accordion-body" style="padding: 1.5rem; line-height: 1.6; animation: fadeIn 0.5s ease;">
                                        We accept all major payment methods including credit cards, debit cards, UPI, net banking, and digital wallets like PhonePe, Google Pay, and Paytm. You can also pay cash on delivery for your convenience.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item" style="margin-bottom: 0.5rem;">
                                ...
                                <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#faqAccordion" style="transition: all 0.4s ease;">
                                    <div class="accordion-body" style="padding: 1.5rem; line-height: 1.6; animation: fadeIn 0.5s ease;">
                                        We deliver fresh meals three times a day: Breakfast (8:00 AM - 10:00 AM), Lunch (12:00 PM - 2:00 PM), and Dinner (7:00 PM - 9:00 PM). Our delivery partners ensure your meals reach you hot and on time.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item" style="margin-bottom: 0.5rem;">
                                ...
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#faqAccordion" style="transition: all 0.4s ease;">
                                    <div class="accordion-body" style="padding: 1.5rem; line-height: 1.6; animation: fadeIn 0.5s ease;">
                                        Choose your preferred meal plan (Basic or Premium), select your delivery preferences, and we'll handle the rest. You can pause, modify, or cancel your subscription anytime through your dashboard. Monthly billing with flexible options.
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <footer class="footer-section">
        <div class="container">
            ...
            <div class="footer-bottom">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        <p>&copy; 2024 Tiffinly. All rights reserved.</p>
                    </div>
                    <div class="col-md-6 text-end">
                        <p>Made with <i class="fas fa-heart text-danger"></i> for food lovers</p>
                    </div>
                </div>
            </div>
        </div>
